...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResourceEnforcementSpec) DeepCopyInto(out *ResourceEnforcementSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResourceEnforcementSpec.
func (in *ResourceEnforcementSpec) DeepCopy() *ResourceEnforcementSpec {
	if in == nil {
		return nil
	}
	out := new(ResourceEnforcementSpec)
	in.DeepCopyInto(out)
	return out
}
